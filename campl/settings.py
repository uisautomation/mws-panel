# Django settings for campl project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'C:\\Users\\rwhb2\\workspace\\campl\\sqlite.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'wdse(z%ojl+x0f8ogt$^v(-5d!rh+zexm7(gu64#ecqs!m+dt-'
...
ROOT_URLCONF = 'campl.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'campl.wsgi.application'
