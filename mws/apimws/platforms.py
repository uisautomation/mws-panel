...
import requests
import platform
from mws.production_secrets import PLATFORMS_API_TOKEN, PLATFORMS_API_USERNAME
...
def get_api_secret():
    if platform.system() == 'Darwin':
        ...
        return sha512_crypt.encrypt(PLATFORMS_API_TOKEN, rounds=5000,
                                    implicit_rounds=True)  # Salt autogenerated
    return crypt.crypt(PLATFORMS_API_TOKEN, "$6$"+''.join(random.sample(string.hexdigits, 16)))


def get_api_username():
    return PLATFORMS_API_USERNAME
